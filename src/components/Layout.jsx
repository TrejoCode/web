    ...
    <div className="flex main column">
      <Head>
        ...
        <title>
          ...
          {title
            ? title + " - Trejocode"
            : "Trejocode - Diseño y desarrollo Web"}{" "}
        </title>
        ...
        <meta
          ...
          content={
            keywords
              ? keywords
              : "Diseño Web, Desarrollo Web, Programación, Aplicaciones, Progressive Web App cancún"
          }
        />
        <meta
          name="description"
          content={
            description
              ? description
              : "Diseño y desarrollo Web, Progressive Web Apps y desarrollo de Software en Cancún | Trejocode"
          }
        />
        {/* --- Open Graph --- */}
        ...
        <meta
          property="og:image"
          content="https://res.cloudinary.com/trejocode/image/upload/v1585867983/Trejocode/og_ccf7n6.jpg"
        />
        <meta
          property="og:title"
          content={
        ...
        <meta
          ...
          content="Trejocode - Diseño y desarrollo Web"
        />
        <meta
