...
const CardProjects = ({ projects, index = null, limit }) => {
  if (index === 0 || index) {
    return projects[index].projects.map(
      (project, key) =>
        key < limit && (
          <div
            className="project project-aqua column wow fadeInLeft"
            ...
            <div className="information column align-center">
              <div className="title full column">
                <div className="web full justify-center">
                  <a
                    className="color-primary-alt text-center font-large weight-semi"
                    href={project.url}
                    target="_blank"
                    rel="noopener"
                  >
    ...
    return projects.map((collection, key) => (
