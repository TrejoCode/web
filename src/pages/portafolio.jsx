...
const PagePortafolio = () => {
  return (
    <Layout
      title="Portafolio"
      description="Explora todos los proyectos que realicé o participé como desarrollador"
    >
      <div className="page-portafolio justify-center">
        <div className="container column">
          ...
          <p className="weight-medium">
            Esta es una colección de proyectos en los que he trabajado a lo
            largo de mis años como desarrollador y estudiante, esto es lo que
            hago y amo hacer.
          </p>
          <div className="white-space-16"></div>
